...
<section id="services" class="text-white py-20 px-6 md:px-12 border-t border-[#4c1920]/30">
    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="group bg-[#4D9DE0]/10 border border-[#b6dff0]/20 rounded-2xl p-6 hover:bg-[#4D9DE0]/15 hover:shadow-lg hover:shadow-[#4D9DE0]/20 hover:scale-[1.03] transform transition-all duration-500 text-left backdrop-blur-sm h-full">
        ...
        <div class="group bg-[#4D9DE0]/10 border border-[#b6dff0]/20 rounded-2xl p-6 hover:bg-[#4D9DE0]/15 hover:shadow-lg hover:shadow-[#4D9DE0]/20 hover:scale-[1.03] transform transition-all duration-500 text-left backdrop-blur-sm h-full">
            ...
            <h3 class="text-lg font-semibold text-[#b6dff0] mb-2">Wa Blast</h3>
            <p class="text-gray-300 text-sm leading-relaxed">
                Turn WhatsApp into your marketing engine. Send personalized offers en masse to build interaction, increase engagement, and drive sales directly from the chat platform.
            </p>
        </div>
