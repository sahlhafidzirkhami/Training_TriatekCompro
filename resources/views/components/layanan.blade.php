    ...
    <div class="container mx-auto px-6 max-w-5xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 -mt-24 relative z-10">
            ...
            <div class="bg-white p-8 rounded-2xl shadow-lg text-center flex flex-col items-center">
                ...
                <a href="{{ route('service.software') }}" class="mt-6 text-sm font-semibold uppercase tracking-wider text-gray-500 hover:text-triatek-primary">{{ __('Layanan.button') }}</a>
            </div>
            ...
            <div class="bg-white p-8 rounded-2xl shadow-lg text-center flex flex-col items-center">
                ...
                <a href="{{ route('services.erp') }}" class="mt-6 text-sm font-semibold uppercase tracking-wider text-gray-500 hover:text-triatek-primary">{{ __('Layanan.button') }}</a>
            </div>
