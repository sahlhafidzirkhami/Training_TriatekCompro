    ...
    <div class="max-w-6xl mx-auto px-6 text-center">
        ...
        <div class="flex flex-col items-center gap-16">
            ...
            <div class="flex flex-col md:flex-row justify-center gap-16 md:gap-12">
                <!-- Service 1 -->
                <div class="group flex flex-col items-start text-left transition-all duration-500 max-w-[280px]"
                ...
                <div class="group flex flex-col items-start text-left transition-all duration-500 max-w-[280px]"
                    ...
                    <div class="mb-6">
                        <img src="/images/uiux-icon.svg" alt="Mobile Development" class="w-10 h-10 text-red-500">
                    </div>
                    <h3 class="text-lg font-semibold mb-4 group-hover:text-red-500 transition-colors duration-300">
                        UI/UX Design
                    </h3>
            ...
            <div class="flex flex-col md:flex-row justify-center gap-16 md:gap-12">
                ...
                <div class="group flex flex-col items-start text-left transition-all duration-500 max-w-[280px]"
                     data-aos="fade-up" data-aos-delay="100">
                    <div class="mb-6">
                        <img src="/images/itconsulting-icon.svg" alt="UI UX Design" class="w-10 h-10 text-red-500">
                    </div>
                    <h3 class="text-lg font-semibold mb-4 group-hover:text-red-500 transition-colors duration-300">
                ...
                <div class="group flex flex-col items-start text-left transition-all duration-500 max-w-[280px]"
                     data-aos="fade-up" data-aos-delay="250">
                    <div class="mb-6">
                        <img src="/images/maintenance-icon.svg" alt="Cloud Infrastructure" class="w-10 h-10 text-red-500">
                    </div>
                    <h3 class="text-lg font-semibold mb-4 group-hover:text-red-500 transition-colors duration-300">
                        Maintenance & Support
                    </h3>
                ...
                <div class="group flex flex-col items-start text-left transition-all duration-500 max-w-[280px]"
                     data-aos="fade-up" data-aos-delay="400">
                    <div class="mb-6">
                        <img src="/images/cloud-icon.svg" alt="IT Consultation" class="w-10 h-10 text-red-500">
                    </div>
                    <h3 class="text-lg font-semibold mb-4 group-hover:text-red-500 transition-colors duration-300">
    ...
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="mb-16" data-aos="fade-up" data-aos-duration="800">
            ...
            <h2 class="text-4xl md:text-5xl font-bold leading-tight max-w-3xl">
                A clear and collaborative process from concept to completion.
            </h2>
        </div>
        ...
        <div class="space-y-10">
            <!-- Step 1 -->
            <div class="flex flex-col md:flex-row md:items-start md:justify-between border-t border-gray-800 pt-8"
                 data-aos="fade-up" data-aos-delay="100">
                <h3 class="text-2xl font-semibold mb-3 md:mb-0 text-white">
                    Discovery & Requirement Analysis
                </h3>
                <p class="text-gray-400 md:w-1/2 leading-relaxed">
                    We start by listening—learning about your operations, challenges, and objectives to help us 
                    define precise requirements and a roadmap that fits your timeline and budget.
                </p>
            </div>
            ...
            <div class="flex flex-col md:flex-row md:items-start md:justify-between border-t border-gray-800 pt-8"
                ...
                <p class="text-gray-400 md:w-1/2 leading-relaxed">
                    Our team crafts clean, user-friendly interfaces and a robust system architecture 
                    to guarantee excellent performance and easy maintenance.
                </p>
            </div>
            ...
            <div class="flex flex-col md:flex-row md:items-start md:justify-between border-t border-gray-800 pt-8"
                ...
                <p class="text-gray-400 md:w-1/2 leading-relaxed">
                    Using modern programming languages and frameworks, our developers deliver features 
                    in iterative sprints, so you can see progress early and provide feedback.
                </p>
            </div>
            ...
            <div class="flex flex-col md:flex-row md:items-start md:justify-between border-t border-gray-800 pt-8"
                ...
                <p class="text-gray-400 md:w-1/2 leading-relaxed">
                    We run thorough manual and automated tests to ensure your software 
                    is secure, fast, and bug-free before launch.
                </p>
            </div>
            ...
            <div class="flex flex-col md:flex-row md:items-start md:justify-between border-t border-gray-800 pt-8"
                ...
                <p class="text-gray-400 md:w-1/2 leading-relaxed">
                    We handle setup, data migration, and integration with your existing systems 
                    for a smooth, disruption-free rollout.
                </p>
            </div>

            <!-- Step 6 -->
            <div class="flex flex-col md:flex-row md:items-start md:justify-between border-t border-gray-800 pt-8 border-b pb-8"
                 data-aos="fade-up" data-aos-delay="600">
                <h3 class="text-2xl font-semibold mb-3 md:mb-0 text-white">
                    Continuous Support & Enhancement
                </h3>
                <p class="text-gray-400 md:w-1/2 leading-relaxed">
                    After launch, we monitor performance, provide updates, 
                    and add new features as your business evolves.
                </p>
            </div>
        </div>
    </div>
        ...
        <div data-aos="fade-left" data-aos-duration="800">
            ...
            <div class="space-y-6">
                ...
                <div class="flex items-start gap-4" data-aos="fade-up" data-aos-delay="100">
                    <span class="text-red-500 text-2xl font-bold">01</span>
                ...
                <div class="flex items-start gap-4" data-aos="fade-up" data-aos-delay="200">
                    <span class="text-red-500 text-2xl font-bold">02</span>
                    <p class="text-gray-300 leading-relaxed">
                ...
                <div class="flex items-start gap-4" data-aos="fade-up" data-aos-delay="300">
                    <span class="text-red-500 text-2xl font-bold">03</span>
                    <p class="text-gray-300 leading-relaxed">
                ...
                <div class="flex items-start gap-4" data-aos="fade-up" data-aos-delay="400">
                    <span class="text-red-500 text-2xl font-bold">04</span>
                    <p class="text-gray-300 leading-relaxed">
